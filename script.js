document.addEventListener('DOMContentLoaded', () => {
  ...
  // 이름을 버튼으로 생성하는 함수
  function createAttendanceButtons(names, containerId) {
